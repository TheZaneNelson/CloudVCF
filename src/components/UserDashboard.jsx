...
import { PlusCircle, ListChecks, Clock, Users, ExternalLink, RefreshCw, Eye } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sessions.map((session, index) => {
            ...
            return (
              ...
              >
                <Card className={`glass-effect neon-glow ${isSessionExpired ? 'border-gray-600/30 opacity-70' : 'border-purple-500/30'}`}>
                  <CardHeader>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center text-sm text-gray-400">
                     ...
                     <Button 
                        ...
                        variant="outline"
                        className={`w-full mt-2 ${isSessionExpired ? 'border-gray-500/30 text-gray-400 hover:bg-gray-500/20' : 'border-purple-400/30 text-purple-300 hover:bg-purple-500/20'}`}
                      >
